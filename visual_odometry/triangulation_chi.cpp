...
//    }
    ...
    // triangulation
    vector<Point3d> points;
    triangulation ( key_points_1, key_points_2, good_matches, R, t, points);
    cout<<"all points_3d after inhomogenious "<<endl<<points<<endl;
    ...
    {
        // first graph
        Point2d pt1_cam = pixel2cam( key_points_1[good_matches[i].queryIdx].pt, K);
        Point2d pt1_cam_3d(
        ...
        // second graph
        Point2d pt2_cam = pixel2cam( key_points_2[good_matches[i].trainIdx].pt, K);
        ...
        vector<Point3d>& points )
{
    ...
    Mat pts_4d; // homogeneous coordinate
    cv::triangulatePoints( T1, T2, points_1, points_2, pts_4d );
    cout<<"all points_4D from cv_train "<<endl<<pts_4d<<endl;
    // homogeneous coordinate --> in-homogeneous coordinate
